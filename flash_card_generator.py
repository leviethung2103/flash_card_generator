...
# File names
INPUT_FILE_NAME     = 'Input.xlsx'                 # Input file which shall contain 2 columns. The column "A" shall contain each text which goes on the front of the cards. Column "B" shall contain the items which goes on the back of the cards.
